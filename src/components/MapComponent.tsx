...
import StationPop from "./StationPopup";
...
const stations: {
  ...
  update: string; // ISO-Zeitstempel
}[] = [
  {
    id: 1,
    name: "Mainz Hauptbahnhof",
    status: "aktiv",
    position: [49.9986, 8.259],
    capacity: 22,
    bikes_available: 11,
    docks_available: 11,
    update: "2025-11-19 15:45:00"
  },
  {
    id: 2,
    name: "Universität Mainz",
    status: "inaktiv",
    position: [49.9903, 8.2397],
    capacity: 18,
    bikes_available: 0,
    docks_available: 18,
    update: "2025-11-19 15:42:00"
  }
];
